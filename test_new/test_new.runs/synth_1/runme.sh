...
HD_PWD='C:/Users/Paula Hreniuc/test_new/test_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mpg2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mpg2.tcl
