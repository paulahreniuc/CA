...
HD_PWD='C:/Users/Paula Hreniuc/test_new/test_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mpg2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mpg2.tcl -notrace
